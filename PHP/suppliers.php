...
<body>
    ...
    <div class="container text-center">
        <h1>Suppliers</h1>
        <p><a href="supplierAdd.php" class="btn btn-primary">Add New Supplier</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                href="newSuppProdForm.php" class="btn btn-primary">New Supplier/Product Interaction</a></p>
        <br>
        <table class="table">
            <thead>
                <tr>
