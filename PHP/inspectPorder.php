...
<body>
    ...
    <div class="container text-center">
        <p><a class="btn btn-success" href="./authorisePorder.php"><i class="fas fa-check"></i>
                ...
                href="createIssue.php"><i class="fas fa-exclamation-triangle"></i> Flag Issue</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                class="btn btn-danger" href="closePorder.php"><i class="fas fa-lock"></i> Close Request</a>&nbsp;&nbsp;&nbsp;&nbsp;<a
                class="btn btn-danger" href="deletePorder.php"><i class="fas fa-trash-alt"></i> Delete</a></p>
